...
mw_ip_create util_mw_adc_bridge_ctl
mw_ip_files util_mw_adc_bridge_ctl [list \
    "util_mw_adc_bridge_ctl.v" ]

mw_ip_properties_lite util_mw_adc_bridge_ctl


set_property driver_value 0 [ipx::get_ports *bridge_in* -of_objects [ipx::current_core]]
set_property driver_value 0 [ipx::get_ports *adc_data_* -of_objects [ipx::current_core]]
set_property driver_value 0 [ipx::get_ports *adc_enable_* -of_objects [ipx::current_core]]
set_property driver_value 0 [ipx::get_ports *adc_valid_* -of_objects [ipx::current_core]]
