...
#
# Generated by export_simulation on Tue Apr 09 10:36:09 EDT 2019
#
################################################################################
...
'-reset_run' switch to the './gsram2.sh' script.
...
./gsram2.sh -noclean_files

For more information on the script, please type './gsram2.sh -help'.
