...
BEGIN
  ...
  led_counter_process: process(clk200)
  begin
    if clk200'event and clk200 = '1' then
        if reset200 = '1' then
            led_counter <= x"00000000";
        elsif enb200 = '1' then
            if led_counter >= x"02FAF080" then
                led_counter <= x"00000000";
            else
  ...
  led_out <= '1' when led_counter >= x"02625A00" else '0';
...
--  ch2_i <= x"0000";
--  ch2_q <= x"0000";
--  channel_estimator_out5 <= x"00000000";
--  channel_estimator_out6 <= x"00000000";
--  channel_estimator_out7 <= x"00";
--  channel_estimator_out8 <= x"00000000";
--  channel_estimator_out9 <= x"00000000";
--  channel_estimator_out10 <= x"00000000";
--  channel_estimator_out11 <= "000000000000000";
