...
// Command     : write_verilog -force -mode synth_stub -rename_top rx_ram_core -prefix
//               rx_ram_core_ rx_ram_core_stub.v
// Design      : rx_ram_core
...
module rx_ram_core(clka, wea, addra, dina, douta, clkb, web, addrb, dinb, 
  doutb)
