...
ENTITY ZynqBF_2t_ip_src_peakdetect_ch1 IS
...
ARCHITECTURE rtl OF ZynqBF_2t_ip_src_peakdetect_ch1 IS
  ...
  COMPONENT ZynqBF_2t_ip_src_correlator1
    PORT( clk                             :   IN    std_logic;
          reset                           :   IN    std_logic;
          enb                             :   IN    std_logic;
  ...
  FOR ALL : ZynqBF_2t_ip_src_correlator1
    USE ENTITY work.ZynqBF_2t_ip_src_correlator1(rtl);
...
BEGIN
  u_correlator1 : ZynqBF_2t_ip_src_correlator1
    PORT MAP( clk => clk,
              reset => reset,
              enb => enb,
