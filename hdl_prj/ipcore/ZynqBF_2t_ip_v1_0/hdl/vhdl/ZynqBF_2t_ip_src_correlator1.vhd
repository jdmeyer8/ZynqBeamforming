...
-- -------------------------------------------------------------
-- 
-- Module: ZynqBF_2t_ip_src_correlator1
...
ENTITY ZynqBF_2t_ip_src_correlator1 IS
...
END ZynqBF_2t_ip_src_correlator1;


ARCHITECTURE rtl OF ZynqBF_2t_ip_src_correlator1 IS
  ...
  COMPONENT ZynqBF_2t_ip_src_gold_sequences
    PORT( clk                             :   IN    std_logic;
          reset                           :   IN    std_logic;
          enb                             :   IN    std_logic;
  ...
  FOR ALL : ZynqBF_2t_ip_src_gold_sequences
    USE ENTITY work.ZynqBF_2t_ip_src_gold_sequences(rtl);
...
BEGIN
  ...
  u_gold_sequences : ZynqBF_2t_ip_src_gold_sequences
    PORT MAP( clk => clk,
              reset => reset,
              enb => enb,
              addr => gs_addr,  -- ufix6
