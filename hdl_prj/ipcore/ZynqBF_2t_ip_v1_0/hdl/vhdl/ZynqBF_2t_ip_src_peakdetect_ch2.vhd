-- -------------------------------------------------------------
-- 
-- File Name: hdl_prj\hdlsrc\ZynqBF_2tx_fpga\ZynqBF_2t_ip_src_peakdetect_ch2.vhd
...
-- -------------------------------------------------------------
-- 
-- Module: ZynqBF_2t_ip_src_peakdetect_ch2
...
ENTITY ZynqBF_2t_ip_src_peakdetect_ch2 IS
...
END ZynqBF_2t_ip_src_peakdetect_ch2;


ARCHITECTURE rtl OF ZynqBF_2t_ip_src_peakdetect_ch2 IS

  -- Component Declarations
  COMPONENT ZynqBF_2t_ip_src_correlator2
    PORT( clk                             :   IN    std_logic;
          reset                           :   IN    std_logic;
          enb                             :   IN    std_logic;
  ...
  COMPONENT ZynqBF_2t_ip_src_peak_fsm_block
    PORT( clk                             :   IN    std_logic;
          reset                           :   IN    std_logic;
          enb                             :   IN    std_logic;
  ...
  COMPONENT ZynqBF_2t_ip_src_running_max_block
    PORT( clk                             :   IN    std_logic;
          reset                           :   IN    std_logic;
          enb                             :   IN    std_logic;
  ...
  COMPONENT ZynqBF_2t_ip_src_store_index_block
    PORT( clk                             :   IN    std_logic;
          reset                           :   IN    std_logic;
          enb                             :   IN    std_logic;
  ...
  FOR ALL : ZynqBF_2t_ip_src_correlator2
    USE ENTITY work.ZynqBF_2t_ip_src_correlator2(rtl);

  FOR ALL : ZynqBF_2t_ip_src_peak_fsm_block
    USE ENTITY work.ZynqBF_2t_ip_src_peak_fsm_block(rtl);

  FOR ALL : ZynqBF_2t_ip_src_running_max_block
    USE ENTITY work.ZynqBF_2t_ip_src_running_max_block(rtl);

  FOR ALL : ZynqBF_2t_ip_src_store_index_block
    USE ENTITY work.ZynqBF_2t_ip_src_store_index_block(rtl);
...
BEGIN
  u_correlator2 : ZynqBF_2t_ip_src_correlator2
    PORT MAP( clk => clk,
              reset => reset,
              enb => enb,
  ...
  u_peak_fsm : ZynqBF_2t_ip_src_peak_fsm_block
    PORT MAP( clk => clk,
              reset => reset,
              enb => enb,
  ...
  u_running_max : ZynqBF_2t_ip_src_running_max_block
    PORT MAP( clk => clk,
              reset => reset,
              enb => enb,
  ...
  u_store_index : ZynqBF_2t_ip_src_store_index_block
    PORT MAP( clk => clk,
              reset => reset,
              enb => enb,
